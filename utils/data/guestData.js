...
const getSingleGuest = async (guestUuid) => {
  const guest = await coordinates.get(`/guests/${guestUuid}`);
  return guest.data;
};

const getSingleReadOnlyGuest = async (guestId) => {
